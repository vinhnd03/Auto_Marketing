          ...
          <div className="px-6 py-6">
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-600">{formData.position} tại {formData.company}</p>
                <p className="text-sm text-gray-500 mt-1">Thành viên từ tháng 1/2024</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="px-6 py-6">
            ...
            <div className="mt-6">
              ...
              {isEditing ? (
                ...
                <p className="text-gray-900 py-2 leading-relaxed">{formData.bio}</p>
              )}
            </div>
          </div>
        </div>
